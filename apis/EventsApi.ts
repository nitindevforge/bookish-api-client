...
export class EventsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param limit 
     */
    public async eventControllerGetEvents(page: number, limit?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'page' is not null or undefined
        if (page === null || page === undefined) {
            throw new RequiredError("EventsApi", "eventControllerGetEvents", "page");
        }
