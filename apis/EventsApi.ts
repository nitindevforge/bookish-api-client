...
export class EventsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param eventId 
     */
    public async eventControllerFinMyEvent(eventId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'eventId' is not null or undefined
        if (eventId === null || eventId === undefined) {
            throw new RequiredError("EventsApi", "eventControllerFinMyEvent", "eventId");
        }
     ...
     * @param limit 
     */
    public async eventControllerFinMyEvents(page: number, limit: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'page' is not null or undefined
        if (page === null || page === undefined) {
            throw new RequiredError("EventsApi", "eventControllerFinMyEvents", "page");
        }


        // verify required parameter 'limit' is not null or undefined
        if (limit === null || limit === undefined) {
            throw new RequiredError("EventsApi", "eventControllerFinMyEvents", "limit");
        }
...
export class EventsApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to eventControllerFinMyEvent
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async eventControllerFinMyEventWithHttpInfo(response: ResponseContext): Promise<HttpInfo<MyEventResponseDto >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to eventControllerFinMyEvents
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async eventControllerFinMyEventsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<MyEventsResponseDto >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
