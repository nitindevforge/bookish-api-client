 ...
 * no description
 */
export class UploadApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async fileUploadControllerGetPreSignedURL(fileUploadPayloadDto: FileUploadPayloadDto, _options?: Configuration): Promise<RequestContext> {
        ...
        if (fileUploadPayloadDto === null || fileUploadPayloadDto === undefined) {
            throw new RequiredError("UploadApi", "fileUploadControllerGetPreSignedURL", "fileUploadPayloadDto");
        }


        // Path Params
        const localVarPath = '/v1/upload/file';
...
export class UploadApiResponseProcessor {
