...
var ObservableBooksApi = (function () {
    ...
    ObservableBooksApi.prototype.bookControllerFindTopUserSetupBooksWithHttpInfo = function (rate, page, limit, search, user, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.bookControllerFindTopUserSetupBooks(rate, page, limit, search, user, _options);
        var middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)(function (rsp) { return _this.responseProcessor.bookControllerFindTopUserSetupBooksWithHttpInfo(rsp); }));
        }));
    };
    ObservableBooksApi.prototype.bookControllerFindTopUserSetupBooks = function (rate, page, limit, search, user, _options) {
        return this.bookControllerFindTopUserSetupBooksWithHttpInfo(rate, page, limit, search, user, _options).pipe((0, rxjsStub_2.map)(function (apiResponse) { return apiResponse.data; }));
    };
