...
var ObservableEventsApi = (function () {
    ...
    ObservableEventsApi.prototype.eventControllerFindMyUpcomingEventsWithHttpInfo = function (page, limit, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.eventControllerFindMyUpcomingEvents(page, limit, _options);
        var middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
    ...
    ObservableEventsApi.prototype.eventControllerFindMyUpcomingEvents = function (page, limit, _options) {
        return this.eventControllerFindMyUpcomingEventsWithHttpInfo(page, limit, _options).pipe((0, rxjsStub_2.map)(function (apiResponse) { return apiResponse.data; }));
    };
