...
export declare class PromiseEventsApi {
    ...
    eventControllerFindMyUpcomingEventsWithHttpInfo(type: 'UPCOMING' | 'VISITED', page: number, limit: number, _options?: Configuration): Promise<HttpInfo<MyEventsResponseDto>>;
    eventControllerFindMyUpcomingEvents(type: 'UPCOMING' | 'VISITED', page: number, limit: number, _options?: Configuration): Promise<MyEventsResponseDto>;
}
