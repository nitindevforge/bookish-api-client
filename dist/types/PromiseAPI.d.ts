...
export declare class PromiseEventsApi {
    ...
    eventControllerUpcomingMyEventsWithHttpInfo(page: number, limit: number, _options?: Configuration): Promise<HttpInfo<MyEventsResponseDto>>;
    eventControllerUpcomingMyEvents(page: number, limit: number, _options?: Configuration): Promise<MyEventsResponseDto>;
}
