...
export declare class PromiseBooksApi {
    ...
    bookControllerFindBookReviewBaseWithHttpInfo(type: string, page: number, limit: number, rate?: number, search?: string, _options?: Configuration): Promise<HttpInfo<BooksReviewResponseDto>>;
    bookControllerFindBookReviewBase(type: string, page: number, limit: number, rate?: number, search?: string, _options?: Configuration): Promise<BooksReviewResponseDto>;
    bookControllerFindBooksWithHttpInfo(search: string, page: number, limit: number, rate?: number, _options?: Configuration): Promise<HttpInfo<BooksResponseDto>>;
    bookControllerFindBooks(search: string, page: number, limit: number, rate?: number, _options?: Configuration): Promise<BooksResponseDto>;
...
export declare class PromiseEventsApi {
    ...
    eventControllerDeleteEventWithHttpInfo(id: string, _options?: Configuration): Promise<HttpInfo<EventDeleteResponseDto>>;
    eventControllerDeleteEvent(id: string, _options?: Configuration): Promise<EventDeleteResponseDto>;
...
export declare class PromiseFollowerApi {
    ...
    followerControllerFindMyFriendsWithHttpInfo(page: number, limit: number, search?: string, _options?: Configuration): Promise<HttpInfo<MyAllFriendsResponseDto>>;
    followerControllerFindMyFriends(page: number, limit: number, search?: string, _options?: Configuration): Promise<MyAllFriendsResponseDto>;
