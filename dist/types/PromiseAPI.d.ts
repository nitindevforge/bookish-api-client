...
export declare class PromisePaymentApi {
    ...
    paymentControllerCreatePaymentIntentWithHttpInfo(stripeCreatePayloadDto: StripeCreatePayloadDto, _options?: Configuration): Promise<HttpInfo<StripeResponseDto>>;
    paymentControllerCreatePaymentIntent(stripeCreatePayloadDto: StripeCreatePayloadDto, _options?: Configuration): Promise<StripeResponseDto>;
