...
export declare class ObservableEventsApi {
    ...
    eventControllerDeleteBookMarkEventWithHttpInfo(bookMarkEventPayloadDto: BookMarkEventPayloadDto, _options?: Configuration): Observable<HttpInfo<DeleteBookMarkEventResponseDto>>;
    eventControllerDeleteBookMarkEvent(bookMarkEventPayloadDto: BookMarkEventPayloadDto, _options?: Configuration): Observable<DeleteBookMarkEventResponseDto>;
    ...
    eventControllerGetBookMarkEventListWithHttpInfo(bookMarkEventsListPayloadDto: BookMarkEventsListPayloadDto, _options?: Configuration): Observable<HttpInfo<BookMarkEventListResponseDto>>;
    eventControllerGetBookMarkEventList(bookMarkEventsListPayloadDto: BookMarkEventsListPayloadDto, _options?: Configuration): Observable<BookMarkEventListResponseDto>;
