...
export declare class ObservableAuthApi {
    ...
    authControllerAddFeedbackWithHttpInfo(feedbackPayloadDto: FeedbackPayloadDto, _options?: Configuration): Observable<HttpInfo<FeedbackCreateResponseDto>>;
    authControllerAddFeedback(feedbackPayloadDto: FeedbackPayloadDto, _options?: Configuration): Observable<FeedbackCreateResponseDto>;
...
export declare class ObservableBooksApi {
    ...
    bookControllerDeleteReviewWithHttpInfo(userBookPayloadDto: UserBookPayloadDto, _options?: Configuration): Observable<HttpInfo<UserBookDeleteResponseDto>>;
    bookControllerDeleteReview(userBookPayloadDto: UserBookPayloadDto, _options?: Configuration): Observable<UserBookDeleteResponseDto>;
    ...
    bookControllerFindBooksWithHttpInfo(rate: number, page: number, limit: number, search?: string, isPrompt?: boolean, user?: string, _options?: Configuration): Observable<HttpInfo<BooksResponseDto>>;
    bookControllerFindBooks(rate: number, page: number, limit: number, search?: string, isPrompt?: boolean, user?: string, _options?: Configuration): Observable<BooksResponseDto>;
    ...
    bookControllerFindTopBooksWithHttpInfo(rate: number, page: number, limit: number, search?: string, isPrompt?: boolean, user?: string, _options?: Configuration): Observable<HttpInfo<BooksReviewResponseDto>>;
    bookControllerFindTopBooks(rate: number, page: number, limit: number, search?: string, isPrompt?: boolean, user?: string, _options?: Configuration): Observable<BooksReviewResponseDto>;
    ...
    bookControllerUpdateBookPositionWithHttpInfo(bookPositionDto: BookPositionDto, _options?: Configuration): Observable<HttpInfo<BookResponseDto>>;
    bookControllerUpdateBookPosition(bookPositionDto: BookPositionDto, _options?: Configuration): Observable<BookResponseDto>;
...
export declare class ObservableContactApi {
    ...
    contactControllerSyncContactsWithHttpInfo(contactDetails: Array<ContactDetails>, _options?: Configuration): Observable<HttpInfo<ContactDetailsDto>>;
    contactControllerSyncContacts(contactDetails: Array<ContactDetails>, _options?: Configuration): Observable<ContactDetailsDto>;
}
