...
export declare class ObservableBooksApi {
    ...
    bookControllerFindBooksWithHttpInfo(search: string, rate: number, page: number, limit: number, _options?: Configuration): Observable<HttpInfo<BooksResponseDto>>;
    bookControllerFindBooks(search: string, rate: number, page: number, limit: number, _options?: Configuration): Observable<BooksResponseDto>;
...
export declare class ObservableEventsApi {
    ...
    eventControllerDeleteEventWithHttpInfo(id: string, _options?: Configuration): Observable<HttpInfo<EventDeleteResponseDto>>;
    eventControllerDeleteEvent(id: string, _options?: Configuration): Observable<EventDeleteResponseDto>;
