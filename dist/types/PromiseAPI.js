...
var PromiseBooksApi = (function () {
    ...
    PromiseBooksApi.prototype.bookControllerFindBookReviewBaseWithHttpInfo = function (type, page, limit, rate, search, _options) {
        var result = this.api.bookControllerFindBookReviewBaseWithHttpInfo(type, page, limit, rate, search, _options);
        return result.toPromise();
    };
    PromiseBooksApi.prototype.bookControllerFindBookReviewBase = function (type, page, limit, rate, search, _options) {
        var result = this.api.bookControllerFindBookReviewBase(type, page, limit, rate, search, _options);
        return result.toPromise();
    };
    PromiseBooksApi.prototype.bookControllerFindBooksWithHttpInfo = function (search, page, limit, rate, _options) {
        var result = this.api.bookControllerFindBooksWithHttpInfo(search, page, limit, rate, _options);
        return result.toPromise();
    };
    PromiseBooksApi.prototype.bookControllerFindBooks = function (search, page, limit, rate, _options) {
        var result = this.api.bookControllerFindBooks(search, page, limit, rate, _options);
        return result.toPromise();
    };
