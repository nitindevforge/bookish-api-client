...
export declare class BooksApiRequestFactory extends BaseAPIRequestFactory {
    ...
    bookControllerFindUserBookReview(bookId: string, isRead?: boolean, rate?: number, review?: string, _options?: Configuration): Promise<RequestContext>;
    bookControllerFindUserBookReviewCount(bookId: string, isRead?: boolean, rate?: number, review?: string, _options?: Configuration): Promise<RequestContext>;
    bookControllerFindUserBookReviews(bookId: string, page: number, limit: number, _options?: Configuration): Promise<RequestContext>;
    bookControllerFindUserBooks(page: number, limit: number, _options?: Configuration): Promise<RequestContext>;
