...
var ContactApiRequestFactory = (function (_super) {
    ...
    ContactApiRequestFactory.prototype.contactControllerSyncContacts = function (contactDetails, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (contactDetails === null || contactDetails === undefined) {
                            throw new baseapi_1.RequiredError("ContactApi", "contactControllerSyncContacts", "contactDetails");
                        }
                        localVarPath = '/v1/contact/sync';
                        ...
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(contactDetails, "Array<ContactDetails>", ""), contentType);
...
var ContactApiResponseProcessor = (function () {
    ...
    ContactApiResponseProcessor.prototype.contactControllerSyncContactsWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
