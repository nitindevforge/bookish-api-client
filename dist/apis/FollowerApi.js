...
exports.FollowerApiResponseProcessor = exports.FollowerApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var FollowerApiRequestFactory = (function (_super) {
    __extends(FollowerApiRequestFactory, _super);
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(followerPayloadDto, "FollowerPayloadDto", ""), contentType);
    ...
    FollowerApiRequestFactory.prototype.followerControllerMyFriends = function (page, limit, search, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (page === null || page === undefined) {
                            throw new baseapi_1.RequiredError("FollowerApi", "followerControllerMyFriends", "page");
                        }
                        if (limit === null || limit === undefined) {
                            throw new baseapi_1.RequiredError("FollowerApi", "followerControllerMyFriends", "limit");
                        }
    ...
    return FollowerApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.FollowerApiRequestFactory = FollowerApiRequestFactory;
var FollowerApiResponseProcessor = (function () {
    ...
    FollowerApiResponseProcessor.prototype.followerControllerMyFriendsWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, _j, _k;
            return __generator(this, function (_l) {
                switch (_l.label) {
    ...
    return FollowerApiResponseProcessor;
}());
exports.FollowerApiResponseProcessor = FollowerApiResponseProcessor;
//# sourceMappingURL=FollowerApi.js.map