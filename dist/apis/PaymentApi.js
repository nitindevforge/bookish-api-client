...
var PaymentApiRequestFactory = (function (_super) {
    ...
    PaymentApiRequestFactory.prototype.paymentControllerDeletePayment = function (paymentPayloadDto, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (paymentPayloadDto === null || paymentPayloadDto === undefined) {
                            throw new baseapi_1.RequiredError("PaymentApi", "paymentControllerDeletePayment", "paymentPayloadDto");
                        }
                        localVarPath = '/v1/payment/intent';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.DELETE);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
...
var PaymentApiResponseProcessor = (function () {
    ...
    PaymentApiResponseProcessor.prototype.paymentControllerDeletePaymentWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, _j, _k;
            return __generator(this, function (_l) {
                switch (_l.label) {
