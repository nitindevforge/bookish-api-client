...
var BooksApiRequestFactory = (function (_super) {
    ...
    BooksApiRequestFactory.prototype.bookControllerFindTopUserSetupBooks = function (rate, page, limit, search, user, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (rate === null || rate === undefined) {
                            throw new baseapi_1.RequiredError("BooksApi", "bookControllerFindTopUserSetupBooks", "rate");
                        }
                        if (page === null || page === undefined) {
                            throw new baseapi_1.RequiredError("BooksApi", "bookControllerFindTopUserSetupBooks", "page");
                        }
                        if (limit === null || limit === undefined) {
                            throw new baseapi_1.RequiredError("BooksApi", "bookControllerFindTopUserSetupBooks", "limit");
                        }
                        localVarPath = '/v1/top/books/setup';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        if (search !== undefined) {
                            requestContext.setQueryParam("search", ObjectSerializer_1.ObjectSerializer.serialize(search, "string", ""));
...
var BooksApiResponseProcessor = (function () {
    ...
    BooksApiResponseProcessor.prototype.bookControllerFindTopUserSetupBooksWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, _j, _k;
            return __generator(this, function (_l) {
                switch (_l.label) {
