...
var BooksApiRequestFactory = (function (_super) {
    ...
    BooksApiRequestFactory.prototype.bookControllerFindRecentReads = function (page, limit, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (page === null || page === undefined) {
                            throw new baseapi_1.RequiredError("BooksApi", "bookControllerFindRecentReads", "page");
                        }
                        if (limit === null || limit === undefined) {
                            throw new baseapi_1.RequiredError("BooksApi", "bookControllerFindRecentReads", "limit");
                        }
                        localVarPath = '/v1/book/reads';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        if (page !== undefined) {
                            requestContext.setQueryParam("page", ObjectSerializer_1.ObjectSerializer.serialize(page, "number", ""));
    ...
    BooksApiRequestFactory.prototype.bookControllerRecentRead = function (recentReadPayloadDto, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (recentReadPayloadDto === null || recentReadPayloadDto === undefined) {
                            throw new baseapi_1.RequiredError("BooksApi", "bookControllerRecentRead", "recentReadPayloadDto");
                        }
                        localVarPath = '/v1/book/read';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                            "application/json"
...
var BooksApiResponseProcessor = (function () {
    ...
    BooksApiResponseProcessor.prototype.bookControllerFindRecentReadsWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, _j, _k;
            return __generator(this, function (_l) {
                switch (_l.label) {
    ...
    BooksApiResponseProcessor.prototype.bookControllerRecentReadWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, _j, _k;
            return __generator(this, function (_l) {
                switch (_l.label) {
