...
var BooksApiRequestFactory = (function (_super) {
    ...
    BooksApiRequestFactory.prototype.bookControllerFindUserBookReview = function (bookId, isRead, rate, review, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (isRead !== undefined) {
                            requestContext.setQueryParam("isRead", ObjectSerializer_1.ObjectSerializer.serialize(isRead, "boolean", ""));
                        }
                        if (rate !== undefined) {
    ...
    BooksApiRequestFactory.prototype.bookControllerFindUserBookReviewCount = function (bookId, isRead, rate, review, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, authMethod, defaultAuth;
            return __generator(this, function (_d) {
    ...
    BooksApiRequestFactory.prototype.bookControllerFindUserBookReviews = function (bookId, page, limit, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        localVarPath = '/v1/user/books/review';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        if (bookId !== undefined) {
                            requestContext.setQueryParam("bookId", ObjectSerializer_1.ObjectSerializer.serialize(bookId, "string", ""));
    ...
    BooksApiRequestFactory.prototype.bookControllerFindUserBooks = function (page, limit, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (page === null || page === undefined) {
                            throw new baseapi_1.RequiredError("BooksApi", "bookControllerFindUserBooks", "page");
                        }
                        if (limit === null || limit === undefined) {
                            throw new baseapi_1.RequiredError("BooksApi", "bookControllerFindUserBooks", "limit");
                        }
                        localVarPath = '/v1/user/books';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        if (page !== undefined) {
                            requestContext.setQueryParam("page", ObjectSerializer_1.ObjectSerializer.serialize(page, "number", ""));
...
var BooksApiResponseProcessor = (function () {
    ...
    BooksApiResponseProcessor.prototype.bookControllerFindUserBooksWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, _j, _k;
            return __generator(this, function (_l) {
                switch (_l.label) {
