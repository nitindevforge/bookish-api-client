...
exports.UploadApiResponseProcessor = exports.UploadApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var UploadApiRequestFactory = (function (_super) {
    __extends(UploadApiRequestFactory, _super);
    function UploadApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    UploadApiRequestFactory.prototype.fileUploadControllerGetPreSignedURL = function (fileUploadPayloadDto, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (fileUploadPayloadDto === null || fileUploadPayloadDto === undefined) {
                            throw new baseapi_1.RequiredError("UploadApi", "fileUploadControllerGetPreSignedURL", "fileUploadPayloadDto");
                        }
                        localVarPath = '/v1/upload/file';
    ...
    return UploadApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.UploadApiRequestFactory = UploadApiRequestFactory;
var UploadApiResponseProcessor = (function () {
    function UploadApiResponseProcessor() {
    }
    UploadApiResponseProcessor.prototype.fileUploadControllerGetPreSignedURLWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return UploadApiResponseProcessor;
}());
exports.UploadApiResponseProcessor = UploadApiResponseProcessor;
