...
var EventsApiRequestFactory = (function (_super) {
    ...
    EventsApiRequestFactory.prototype.eventControllerGetEvents = function (page, limit, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (page === null || page === undefined) {
                            throw new baseapi_1.RequiredError("EventsApi", "eventControllerGetEvents", "page");
                        }
...
var EventsApiResponseProcessor = (function () {
    ...
    EventsApiResponseProcessor.prototype.eventControllerGetEventsWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, _j, _k;
            return __generator(this, function (_l) {
                switch (_l.label) {
