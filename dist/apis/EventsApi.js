...
var EventsApiRequestFactory = (function (_super) {
    ...
    EventsApiRequestFactory.prototype.eventControllerGetBookMarkEventList = function (page, limit, userId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, authMethod, defaultAuth;
            return __generator(this, function (_d) {
...
var EventsApiResponseProcessor = (function () {
    ...
    EventsApiResponseProcessor.prototype.eventControllerGetBookMarkEventListWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, _j, _k;
            return __generator(this, function (_l) {
                switch (_l.label) {
